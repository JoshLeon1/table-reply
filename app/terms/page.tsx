...
export const metadata = {
  title: 'Terms of Service — TableReply',
  description: 'Terms and conditions for using TableReply.',
}
        ...
        <div className="space-y-8 text-[#57534E] leading-relaxed">
          ...
          <section>
            ...
            <p className="text-[14px]">
              By creating an account and using TableReply (&ldquo;Service&rdquo;), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[14px]">
              TableReply is a review management platform that helps restaurant owners monitor, respond to, and analyze customer reviews. Features include AI-generated reply suggestions, review analytics, competitor tracking, social post generation, and review request templates.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[14px]">
              TableReply generates reply suggestions using artificial intelligence. These are suggestions only — you are responsible for reviewing content before posting it publicly. We are not liable for any consequences arising from replies you post based on AI suggestions.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-[14px]">
              <li>TableReply offers a 7-day free trial with no credit card required.</li>
          ...
          <section>
            ...
            <p className="text-[14px]">
              The TableReply platform, including its design, code, and branding, is owned by TableReply and protected by intellectual property laws. You retain ownership of your restaurant&rsquo;s data and content. By using the Service, you grant us a limited license to process your data to provide the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[14px]">
              To the fullest extent permitted by law, TableReply shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Service, including but not limited to loss of revenue, reputation, or data.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[14px]">
              Questions? Email us at <a href="mailto:support@tablereply.com" className="text-[#E05A28] hover:underline">support@tablereply.com</a> or visit our <Link href="/contact" className="text-[#E05A28] hover:underline">Contact page</Link>.
            </p>
          </section>
