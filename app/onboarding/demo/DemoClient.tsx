...
export default function DemoClient({ restaurantProfile }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#F3F0EC] flex items-center justify-center p-6">
          ...
          {state === 'done' && (
            <>
              <div className="flex items-center justify-between px-6 py-4 border-b border-[#F0EDE8]">
                ...
                <button
                  onClick={handleCopy}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[13px] font-medium text-[#666] hover:text-[#111] hover:bg-[#F3F0EC] border border-transparent hover:border-[#E4DED8] transition-all"
                >
                  {copied ? (
