    ...
    <div className="space-y-6">
      ...
      {goodReviews.length === 0 ? (
        <div className="bg-white rounded-2xl border border-[#E4DED8] p-12 text-center">
          <div className="w-14 h-14 rounded-full bg-[#F3F0EC] border border-[#E4DED8] flex items-center justify-center mx-auto mb-3 shadow-sm">
          ...
          {goodReviews.map((review) => (
            ...
            >
              ...
              <button
                ...
                className="mt-auto w-full h-[38px] rounded-xl bg-[#E05A28] hover:bg-[#C94E21] text-white text-[12px] font-semibold transition-all duration-150 flex items-center justify-center gap-1.5"
              >
