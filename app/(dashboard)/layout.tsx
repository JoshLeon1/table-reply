...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden" style={{ backgroundColor: '#080808' }}>
      ...
      <div className="pointer-events-none fixed top-0 left-0 right-0 h-96 opacity-60" style={{ background: 'radial-gradient(ellipse 80% 50% at 50% -10%, rgba(224,90,40,0.08), transparent)' }} />
      <Nav />
