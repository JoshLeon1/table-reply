      ...
      <div className="relative bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4">
        <div className="text-center">
          <div className="w-16 h-16 bg-[#FEF0E8] rounded-full flex items-center justify-center mx-auto mb-4">
            <svg className="w-8 h-8 text-[#E05A28]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
          </div>
          <h2 className="text-2xl font-bold text-[#111] mb-2">Your trial has ended</h2>
          <p className="text-[#7C7672] mb-6">
          ...
          <ul className="text-left space-y-3 mb-8">
            {[
              ...
              <li key={feature} className="flex items-center gap-2 text-sm text-[#444]">
          ...
          <p className="mt-3 text-xs text-[#A8A29E]">No surprises. Cancel anytime.</p>
        </div>
      </div>
    </div>
  )
